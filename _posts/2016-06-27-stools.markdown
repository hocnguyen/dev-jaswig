...
The seats are manufactured in Horgau, Germany, and the product specs are [available here](http://www.aeris.de/fileadmin/devjaswig.github.io/images/pdf/en/muvman_product_specification_sheet.pdf)  (more material details).
